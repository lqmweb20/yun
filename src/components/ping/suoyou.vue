<template>
  <div id="quan" class="bgWhite">
    <div class="pt25 pb25 pl30 pr30 font24 gray ping flex flex-ac">
      <svg version="1.1" @click="ho" class="mr10 go" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 768 768">
<g id="icomoon-ignore">
...
<path d="M319.5 544.5l288-288-45-46.5-243 243-114-114-45 45zM384 64.5q132 0 225.75 93.75t93.75 225.75-93.75 225.75-225.75 93.75-225.75-93.75-93.75-225.75 93.75-225.75 225.75-93.75z"></path>
</svg>

      只看有内容的评价
    </div>
   <ul class="plr30 ping1">
     <li v-for="item1 ,index in quan" :key="index" class="ptb25 flex">
        <div class="img mr25">
            <img :src="item1.avatar" alt="">
        </div>
        <div class="fen">
            <div class="flex flex-jb font20">
               
                <p> {{item1.username}}</p>
                <p>2020-07-07 20:33</p>
              </div>
            <div class="flex font20 gray mtb10">
              <div class="flex flex-ac">
                <img class="mr5 xinxin" :src="(index+1)<=item1.score?xinxin:xinxin1" alt="" v-for="item ,index in 5" :key="index">
              </div>
              {{item1.deliveryTime}}分钟送达
            </div>
            <div class="font24 mb10">
              {{item1.text}}
            </div>
            <div class="flex flex-ac">
              <svg v-if="item1.rateType==0" version="1.1" class="mr15" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 768 768"  style="fill:blue">
<g id="icomoon-ignore">
    <line stroke-width="1" x1="16" y1="0" x2="16" y2="768" stroke="#449FDB" opacity="0.3"></line>
    <line stroke-width="1" x1="32" y1="0" x2="32" y2="768" stroke="#449FDB" opacity="1"></line>
    <line stroke-width="1" x1="48" y1="0" x2="48" y2="768" stroke="#449FDB" opacity="0.3"></line>
...
<path d="M736.5 319.5l-1.5 3h1.5v61.5q0 12-4.5 24l-97.5 225q-15 39-58.5 39h-288q-25.5 0-45-19.5t-19.5-45v-319.5q0-25.5 19.5-45l210-211.5 34.5 34.5q13.5 13.5 13.5 33v10.5l-31.5 147h202.5q25.5 0 45 18.75t19.5 44.25zM31.5 672v-384h129v384h-129z"></path>
</svg>
<svg version="1.1" v-else class="mr15" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 768 768">
<g id="icomoon-ignore">
    <line stroke-width="1" x1="16" y1="0" x2="16" y2="768" stroke="#449FDB" opacity="0.3"></line>
    <line stroke-width="1" x1="32" y1="0" x2="32" y2="768" stroke="#449FDB" opacity="1"></line>
    <line stroke-width="1" x1="48" y1="0" x2="48" y2="768" stroke="#449FDB" opacity="0.3"></line>
...
<path d="M607.5 96h129v384h-129v-384zM480 96q25.5 0 45 19.5t19.5 45v319.5q0 25.5-19.5 45l-210 211.5-34.5-34.5q-13.5-13.5-13.5-33v-10.5l31.5-147h-202.5q-25.5 0-45-18.75t-19.5-44.25l1.5-3h-1.5v-61.5q0-12 4.5-24l97.5-225q15-39 58.5-39h288z"></path>
</svg>
              <ul class="flex list cc">
                <li v-for="item,index in item1.recommend" :key="index" class="cutFont mb10"><p class="cutFont">{{item}}</p> 
</li>
              </ul>
            </div>
...
mounted(){
  this.ratings.forEach(d=>{
      if(d.text!=""){
        this.manyi.push(d)
      }
    })
  ;
  setTimeout(()=>this.quan=this.ratings,20)
},
...
methods:{
  ho(){
    ...
    if(this.i){
       this.quan=this.manyi;
      this.i=false
    }else{
      this.i=true
       this.quan=this.ratings
...
svg{
  ...
  height: 0.24rem;
    ...
    #quan{
      ...
      .ping{
        border-bottom: 0.01rem solid rgb(77, 76, 76);
      }
      .ping1{
        &>li:not(:last-child){
        border-bottom: 0.01rem solid rgb(77, 76, 76);
