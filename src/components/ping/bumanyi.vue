<template>
  <div id="quan" class="bgWhite">
   ...
   <ul class="plr30 ping1">
     <li v-for="item1 ,index in man" :key="index" class="ptb25 flex">
        <div class="img mr25">
...
<path d="M607.5 96h129v384h-129v-384zM480 96q25.5 0 45 19.5t19.5 45v319.5q0 25.5-19.5 45l-210 211.5-34.5-34.5q-13.5-13.5-13.5-33v-10.5l31.5-147h-202.5q-25.5 0-45-18.75t-19.5-44.25l1.5-3h-1.5v-61.5q0-12 4.5-24l97.5-225q15-39 58.5-39h288z"></path>
              ...
              <ul class="flex list cc">
                <li v-for="item,index in item1.recommend" :key="index" class="cutFont mb10">
                 <p class="cutFont">{{item}}</p> 
                  </li>
              </ul>
            </div>
